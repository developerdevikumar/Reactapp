                      ...
                      <div className="tm-contact-form-wrap">
                        <form id="contact-form" action="" method="post" className="tm-contact-form">
                            ...
                            <div className="form-group mb-0">
                              <button className="btn rounded-0 d-block ml-auto tm-btn-primary">
                                Send It Now
                              </button>
                            </div>
                          </form>
                    ...
                    <div className="col-lg-6 mb-5 tm-contact-box">
                      <div className="tm-double-border-1 tm-border-gray">
                        <div className="tm-double-border-2 tm-border-gray tm-box-pad">
                            ...
                            <p className="mb-1">Tel: <a href="tel:0900100910" className="tm-link">090-010-0910</a></p>
                            <p>Email: <a href="mailto:info@company.com" className="tm-link">info@company.com</a></p>
                        </div>
                      </div>
                    </div>
                    <Map />
