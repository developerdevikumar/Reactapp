            ...
            <section>
             <div class="row tm-welcome-row">
                    <article class="col-lg-6 tm-media">
                        <img src="../assets/img/img-3x2-01.jpg" alt="Welcome image" class="img-fluid tm-media-img" />
                    ...
                    <article class="col-lg-6 tm-media">
                        <img src="../assets/img/img-3x2-02.jpg" alt="Welcome image" class="img-fluid tm-media-img" />
                        <div class="tm-media-body">
                    ...
                    <article class="col-lg-6 tm-media">
                        <img src="../assets/img/img-3x2-03.jpg" alt="Welcome image" class="img-fluid tm-media-img" />
                        <div class="tm-media-body">
                    ...
                    <article class="col-lg-6 tm-media">
                        <img src="../assets/img/img-3x2-04.jpg" alt="Welcome image" class="img-fluid tm-media-img" />
                        <div class="tm-media-body">
